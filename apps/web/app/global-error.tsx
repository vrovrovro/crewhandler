      ...
      <body className="bg-slate-50">
        <main className="flex min-h-screen items-center justify-center px-6">
          <div className="w-full max-w-lg rounded-[32px] border border-slate-200 bg-white p-8 text-center shadow-[0_18px_48px_rgba(15,23,42,0.08)]">
            <p className="text-xs font-semibold uppercase tracking-[0.32em] text-slate-400">Application error</p>
            <h1 className="mt-4 text-3xl font-semibold text-slate-950">The app could not load</h1>
            <p className="mt-3 text-sm leading-6 text-slate-500">
              {error.message || "Please refresh or return to login."}
            </p>
